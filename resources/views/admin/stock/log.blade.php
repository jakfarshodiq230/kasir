...
<script>
    ...
    $("#datatable-buttons2").DataTable({
        ...
        processing: true,
        ajax: {
            url: "/admin-stock/admin-stock-log-all", // Replace with the Laravel route URL that returns JSON
            dataSrc: "data"
        },
        columns: [
            { data: "id", title: "ID" },
            ...
            { data: "keterangan_stock_cabang", title: "Keterangan" },
            {
                data: null,
                title: "Action",
                orderable: false,
        ...
        buttons: [
            {
                ...
                action: function(e, dt, node, config) {
                    window.location.href = '/admin-stock/add-admin-stock';
                },
            },
            {
                extend: "copy",
    ...
    $(document).on('click', '.delete-btn', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: '/admin-stock/admin-stock-log-delete/' + dataId,
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}',
                    },
