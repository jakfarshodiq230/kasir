...
<div class="right_col" role="main">
    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title">
            <h2>List Permintaan Barang Batal</h2>
...
<script>
    ...
    let table = $("#datatable-buttons2").DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "/gudang-permintaan-batal/permintaan-batal-data-all", // Replace with the Laravel route URL that returns JSON
            data: function(d) {
        ...
        columns: [
            ...
            { data: "transaksi.nama", title: "Nama" },
            {
                ...
                render: function(data, type, row) {
                    ...
                    let tanggal_batal = new Date(row.transaksi.updated_at).toLocaleDateString('id-ID', {
                        weekday: 'long',
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric'
                    ...
                    return `
                        <ul>
                            ...
                            <li class="text-danger"><strong>Tanggal Dibatalkan:</strong> ${tanggal_batal}</li>
                        </ul>
                    `;
                }
            },
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    return `
                        <a href="/gudang-permintaan-batal/permintaan-batal-data-detail/${row.nomor_transaksi}" class="btn btn-sm btn-warning">
