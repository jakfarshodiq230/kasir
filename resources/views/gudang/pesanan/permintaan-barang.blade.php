...
<script>
    ...
    let table = $("#datatable-buttons2").DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "/gudang-permintaan/permintaan-data-all", // Replace with the Laravel route URL that returns JSON
            data: function(d) {
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    return `
                        <a href="/gudang-permintaan/permintaan-data-detail/${row.nomor_transaksi}" class="btn btn-sm btn-warning">
